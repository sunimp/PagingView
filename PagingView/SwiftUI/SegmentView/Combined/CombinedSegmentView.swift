...
/// Combination SegmentedView and SegmentedListContainerView
public struct CombinedSegmentView<T: Hashable, C: View, L: View, N: View>: View {
    ...
    public var body: some View {
        CombinedWappedRepresentableView(
